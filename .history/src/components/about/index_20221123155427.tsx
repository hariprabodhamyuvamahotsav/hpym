...
import smym from './images/smym.png';
...
export const About: FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <section ref={el} className={cn(style.about_Section, extraClasses, 'about_Section')}>
      <div className={cn(style.about_Content)}>
      ...
      <div className={cn(style.about_Upasana_Contain)}>
        <div className={cn(style.upasana_Row_Contain)}>
          <div className={cn(style.upasana_Row)}>
            <Image
              className={style.upasana_Img}
          ...
          <div className={cn(style.upasana_Row)}>
            <Image
              className={style.upasana_Img}
              src={img3} alt='S Maharaj'
              width={200} height={266} />
            <Image
              className={style.upasana_Img}
              src={img4} alt='Y Maharaj'
              width={200} height={266} />
          </div>
        </div>
      </div>
